...
namespace Guncon2Console.TetherScript
{
    static class AbsMouseFeeder
    {
        ...
        internal static void Feed()
        {
            ...
            {
                absX = (short)Helper.ConvertRange(GunState.MinX, GunState.MaxX, 0, 32767, GunState.ABS_X);
                absY = (short)Helper.ConvertRange(GunState.MinY, GunState.MaxY, 0, 32767, GunState.ABS_Y);
