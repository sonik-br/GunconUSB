...
namespace Guncon2Console
{
    public static class GunState
    {
        ...
        public static int MinX { get; set; } = int.MaxValue;
        public static int MaxX { get; set; } = int.MinValue;
        public static int MinY { get; set; } = int.MaxValue;
        public static int MaxY { get; set; } = int.MinValue;
    }
}
